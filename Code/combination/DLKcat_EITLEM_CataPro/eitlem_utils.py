...
class Tester(object):
    ...
    def test(self, model, loader, N, desc):
        ...
        with torch.no_grad():
            ...
            pcc = pearsonr(testY, testPredict)[0]
            return MAE, rmse, r2, loss_total/N, pcc
...
#             scaler.update()
        ...
        train_pcc = pearsonr(testY, testPredict)[0]
        return train_MAE, train_rmse, train_r2, loss_train/N, train_pcc

def get_pair_info(dataset_path, Type, infer=False):
