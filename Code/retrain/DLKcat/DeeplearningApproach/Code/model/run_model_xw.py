...
if __name__ == "__main__":
    ...
    dir_input = ('../../Data/xw_input_kkm_train/')
    ...
    n_fingerprint_train = len(fingerprint_dict)
    n_word_train = len(word_dict)
    
    dir_input = ('../../Data/xw_input_kkm_test/')
    compounds = load_tensor(dir_input + 'compounds', torch.LongTensor)
    adjacencies = load_tensor(dir_input + 'adjacencies', torch.FloatTensor)
    proteins = load_tensor(dir_input + 'proteins', torch.LongTensor)
    interactions = load_tensor(dir_input + 'regression', torch.FloatTensor)
    ...
    n_fingerprint_test = len(fingerprint_dict)
    n_word_test = len(word_dict)
    n_fingerprint = n_fingerprint_train + n_fingerprint_test
    n_word = n_word_train + n_word_test
