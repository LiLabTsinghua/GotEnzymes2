...
print('len(Kcat_data)',len(Kcat_data))  # 69140, in which 22723 mutant 46417 wildtype 
# 78302 # 80540 @ 240820 # 84031 @240925
...
print('len(new_lines)',len(new_lines))  # 67566 included all elements, 52390 included all except for Kcat value and unit, 32305 if further not include enzymeType
#58533 # 59795 only kcat @ 240820  # 62426 only kcat @ 240925
# i = 0
clean_Kcat = list()
...
# print(clean_Kcat)
print('len(clean_Kcat)',len(clean_Kcat))  # 52390
#58533 same as above # 59795 only kcat @240820
...
'''
整理并清理 clean 原始的 Kcat 数据，确保每个数据行只包含唯一的组合，并选择 Kcat 值最大的组合。清理后的数据保存在新的文件中。
'''
