# 先把所有的预训练模型的预测值得到，然后跟indentity_new拼接 最后画图
...
if __name__ == "__main__":
    ...
    topt_pth = f'../data/zuhe/{emb_model}_{args.type0}_window3_best_cv{args.cv}.pth'
    ...
    emb_dict = pickle.load(open(f'/home/wuke/project/bio_deeplearning/zzz_benchmark/pretrain/{args.type0}/{emb_model}_L.pkl', 'rb'))
    for seq in sequence:
