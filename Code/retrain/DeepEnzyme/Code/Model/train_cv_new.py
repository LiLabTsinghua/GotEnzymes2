...
def main():
    ...
    file_MAEs = f'../../Results/Output/dim64_lr001_E200_head4_drop3_seed666_cv{cv}.txt'
    file_model = f'../../Results/Output/dim64_lr001_E200_head4_drop3_seed666_cv{cv}'
    MAEs_header = 'Epoch\tTime(sec)\tLoss_train\tMAE_train\tRMSE_train\tR2_train\tloss_val\tMAE_val\tMAE_test' \
    ...
    for epoch in range(1, iteration + 1):
        ...
        MAEs = [epoch, round(time, 4), round(loss_train, 4), round(MAE_train, 4), round(RMSE_train, 4),
                ...
                round(RMSE_test, 4), round(R2_val, 4), round(R2_test, 4), trainer.optimizer.param_groups[0]['lr']]
