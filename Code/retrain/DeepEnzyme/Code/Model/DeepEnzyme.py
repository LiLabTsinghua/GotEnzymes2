...
class DeepEnzyme(nn.Module):
    ...
    def forward(self, inputs, layer_output, dropout):
        fingerprints, smileadjacency, words, seqadjacency, _ = inputs
        # print('fingerprints.shape, smileadjacency.shape, words.shape, seqadjacency.shape')
        # print(fingerprints.shape, smileadjacency.shape, words.shape, seqadjacency.shape)
        # fingerprints.shape, smileadjacency.shape, words.shape, seqadjacency.shape
        # torch.Size([30]) torch.Size([30, 30]) torch.Size([294]) (293, 293)
